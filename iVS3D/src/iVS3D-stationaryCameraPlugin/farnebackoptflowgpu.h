#ifndef FARNEBACKOPTFLOWGPU_H
#define FARNEBACKOPTFLOWGPU_H
...
/**
 * @class FarnebackOptFlowGPU
 *
 * @ingroup CameraMovementPlugin
 *
 * @brief The FarnebackOptFlowGPU class implements the interface FarnebackOptFlow.
 * It defines the specific methods for executing the Farnback Algorithm on GPU.
 *
 * @author Dominik Wüst
 *
 * @date 2021/04/10
 */
class FarnebackOptFlowGPU : public FarnebackOptFlow
{
public:
    FarnebackOptFlowGPU();
    ~FarnebackOptFlowGPU() override;
    /**
