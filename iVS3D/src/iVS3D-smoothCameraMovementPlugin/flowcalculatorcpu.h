#ifndef FLOWCALCULATORCPU_H
#define FLOWCALCULATORCPU_H
 ...
 *
 * @brief The FlowCalculatorCpu class is a hardware specific implementation of FlowCalculator.
 ...
 * @date 2022/04/12
 */
class FlowCalculatorCpu : public FlowCalculator
{
public:
    /**
     * @brief FlowCalculatorCpu Constructor creates a Farneback object which is used to execute the farneback algortihm later
    ...
    /**
      * @brief FlowCalculatorCpu Destructor cleans up left over data and pointers
      */
    ~FlowCalculatorCpu();
    /**
