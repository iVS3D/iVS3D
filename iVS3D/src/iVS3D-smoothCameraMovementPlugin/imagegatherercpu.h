 ...
 *        cuda specific algorithm. The algorithm reads, resizes and greyscales
 * an frame. This algorithm can be executed on multiple frames at once.
 */
class ImageGathererCpu : public ImageGatherer {
   public:
    ImageGathererCpu(iReader* reader, std::vector<uint> futureFrames);
