...
#TARGET = $$qtLibraryTarget(GeoDistancePlugin)
TARGET = GeoDistance
DESTDIR = ../plugins
...
TRANSLATIONS += \
    $$PWD/translations/geodistance_en.ts \
    $$PWD/translations/geodistance_de.ts

unix:system(lrelease $$PWD/translations/*.ts)
win32:system(lrelease-pro iVS3D-geoDistancePlugin.pro)
