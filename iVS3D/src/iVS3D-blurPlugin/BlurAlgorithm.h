 ...
 * @ingroup BlurPlugin
 *
 * @brief The BlurAlgorithm interface provides an interface for different
 * algorithms calculating blur values for given images.
 *
...
class BlurAlgorithm : public QObject {
   ...
   public:
    ...
    /**
     * @brief calcOneBluriness calculates blur meassure for one image specified
     * by index.
     ...
     * @param blurValues vector with the already calulated blur values (can be
