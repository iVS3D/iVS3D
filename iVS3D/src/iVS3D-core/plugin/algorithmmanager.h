 ...
 * @ingroup Plugin
 *
 * @brief The AlgorithmManager class is a singleton which is responisble for
 * loading and executing the IAlgorithm plugins.
 *
...
class AlgorithmManager : public QObject {
   ...
   public:
    ...
    /**
     * @brief getSettingsWidget Gets the Settings widget from the algorithm with
     * the given index
     ...
     */
    std::vector<uint> sample(std::vector<uint> sharpImages,
                             Progressable* receiver, volatile bool* stopped,
                             int idx, bool useCuda, LogFileParent* logFile);
    ///**
    ...
    /**
     * @brief getIndexToPluginName Takes the index of a plugin and returns it's
     * translated name.
    ...
    /**
     * @brief getPluginFileNameToIndex Takes the index of a plugin and returns
     * it's file name.
     * @param index Index of the plugin
    ...
    /**
     * @brief getPluginNameFromFileName Takes the name of a plugin file and
     * returns it's translated name.
     * @param FileName nmae of the plugin file
     * @return (possibly) translated name of the plugin
     */
    QString getPluginNameFromFileName(QString FileName);
    /**
     * @brief getIndexFromFileName Takes the name of a plugin file and returns
     * its index.
     * @param FileName nmae of the plugin file
    ...
    /**
     * @brief initializePlugins calls the initialize method on all loaded
     * IAlgorithms
     * @param reader The reader needed for the initialize method according to
     * IAlgorithm
     */
    void initializePlugins(iReader* reader,
    ...
    /**
     * @brief generateSettings returns the generated settings of the indexed
     * plugin
     * @param idx Index of the plugin
     ...
     */
    QMap<QString, QVariant> generateSettings(int idx, Progressable* receiver,
                                             bool useCuda,
