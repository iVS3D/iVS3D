...
class VideoPlayerController : public QObject {
   Q_OBJECT  // used to enable signals and slots for this class
        ...
        * both with image data from DataManager. Initializes a timer to
        ...
        * @param algoController an AlgorithmController instance to transform
        * images and preview them
        */
   ...
   public slots:
    ...
    /**
     * @brief [slot] slot_refreshPreview() updates the visualization for the
     * currently displayed image by requesting a new preview from the preview
     * plugin.
     */
   ...
   private slots:
    ...
    void slot_receiveImage(const ImageRequest& request,
