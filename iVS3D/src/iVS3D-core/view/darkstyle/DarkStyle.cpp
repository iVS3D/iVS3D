 ...
 * @ingroup View
 *
 * @brief The DarkStyle class is responsible for the dark style layout. See https://github.com/Jorgen-VikingGod/Qt-Frameless-Window-DarkStyle for more Information
 *
